...
* \details Konstruktor třídy Game_field dědí od třídy QGridLayout. Instanciuje všechny QPixmapy, do kterých jsou uloženy jednotlivé obrázky (herní kompomenty).
