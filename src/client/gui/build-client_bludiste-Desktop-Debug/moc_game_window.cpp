...
#include "../client_bludiste/game_window.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_game_window_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 43, 0)
    ...
    "game_window\0on_send_command_button_clicked\0"
    "\0"
};
...
void game_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_send_command_button_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject game_window::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_game_window.data,
      qt_meta_data_game_window,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_game_window.stringdata))
