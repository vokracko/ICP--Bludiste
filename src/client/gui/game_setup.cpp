...
* \brief Naparsuje textový řetězec str a zobrazí jednotlivé položky do komponenty instance třídy QListWidget.
...
* \brief Vyvolá vytvoření hracího okna a naplnění reference na třídu Client.
*/
